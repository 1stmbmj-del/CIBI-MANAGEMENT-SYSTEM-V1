...
${assignment.cashflowReport?.ciRecommendation?.hasCollateral ? `⚠️ CRITICAL MANDATE: Since this loan has indicated collateral, you MUST include a dedicated subsection titled '#### Collateral Evaluation & Risk Cover' here. Evaluate the collateral type (${assignment.cashflowReport.ciRecommendation.collateralType || "N/A"}), valuation coverage (₱${(assignment.cashflowReport.ciRecommendation.collaterals && assignment.cashflowReport.ciRecommendation.collaterals.length > 0 ? assignment.cashflowReport.ciRecommendation.collaterals.reduce((sum: number, c: any) => sum + Number(c.value100 || 0), 0) : (assignment.cashflowReport.ciRecommendation.collateralValue100 || 0)).toLocaleString()}), and explicitly state and analyze the resulting Amount @ Risk (₱${(Number(assignment.cashflowReport.ciRecommendation.loanAmount || 0) - Number(assignment.cashflowReport.ciRecommendation.collaterals && assignment.cashflowReport.ciRecommendation.collaterals.length > 0 ? assignment.cashflowReport.ciRecommendation.collaterals.reduce((sum: number, c: any) => sum + Number(c.value70 || 0), 0) : (assignment.cashflowReport.ciRecommendation.collateralValue70 || 0))).toLocaleString()}).` : "If there is indicated collateral, include a brief evaluation of the collateral types, valuation coverage, and the resulting Amount @ Risk here."}
...
${assignment.cashflowReport?.ciRecommendation?.hasCollateral ? `- **Collateral Details:** Yes (${assignment.cashflowReport.ciRecommendation.collateralType || "N/A"}), Value @ 100%: ₱${(assignment.cashflowReport.ciRecommendation.collaterals && assignment.cashflowReport.ciRecommendation.collaterals.length > 0 ? assignment.cashflowReport.ciRecommendation.collaterals.reduce((sum: number, c: any) => sum + Number(c.value100 || 0), 0) : (assignment.cashflowReport.ciRecommendation.collateralValue100 || 0)).toLocaleString()}, Amount @ Risk: ₱${(Number(assignment.cashflowReport.ciRecommendation.loanAmount || 0) - Number(assignment.cashflowReport.ciRecommendation.collaterals && assignment.cashflowReport.ciRecommendation.collaterals.length > 0 ? assignment.cashflowReport.ciRecommendation.collaterals.reduce((sum: number, c: any) => sum + Number(c.value70 || 0), 0) : (assignment.cashflowReport.ciRecommendation.collateralValue70 || 0))).toLocaleString()}\n` : ""}
